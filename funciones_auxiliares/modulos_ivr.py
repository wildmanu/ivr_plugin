...
dic_calidad = {
    ...
    '0131': {
        '1': 1.35, '2': 1.20, '3': 1.05, '4': 0.90, '5': 0.80,
...
clasificador_gau = {
    'Cuantiles': {
        2: [
            (0.00000, 0.47367, '#fff5eb'),
            (0.47367, 1.00000, '#7f2704'),
        ],
        3: [
            (0.00000, 0.36386, '#fff5eb'),
            (0.36386, 0.59821, '#fd9243'),
            (0.59821, 1.00000, '#7f2704'),
        ],
        4: [
            (0.00000, 0.30837, '#fff5eb'),
            (0.30837, 0.47367, '#fdbd83'),
            (0.47367, 0.67063, '#ee6511'),
            (0.67063, 1.00000, '#7f2704'),
        ],
        5: [
            (0.00000, 0.27100, '#fff5eb'),
            (0.27100, 0.40784, '#fdd2a5'),
            (0.40784, 0.54453, '#fd9243'),
            (0.54453, 0.71535, '#df5005'),
            (0.71535, 1.00000, '#7f2704'),
        ],
        6: [
            (0.00000, 0.24313, '#fff5eb'),
            (0.24313, 0.36386, '#fddab6'),
            (0.36386, 0.47367, '#fdab67'),
            (0.47367, 0.59821, '#f67723'),
            (0.59821, 0.74530, '#d14501'),
            (0.74530, 1.00000, '#7f2704'),
        ],
        7: [
            (0.00000, 0.22123, '#fff5eb'),
            (0.22123, 0.33295, '#fee0c2'),
            (0.33295, 0.42661, '#fdbd83'),
            (0.42661, 0.52216, '#fd9243'),
            (0.52216, 0.63953, '#ee6511'),
            (0.63953, 0.76734, '#c24002'),
            (0.76734, 1.00000, '#7f2704'),
        ],
        8: [
            (0.00000, 0.20238, '#fff5eb'),
            (0.20238, 0.30837, '#fee4ca'),
            (0.30837, 0.39080, '#fdc997'),
            (0.39080, 0.47367, '#fda45d'),
            (0.47367, 0.56383, '#f87f2c'),
            (0.56383, 0.67063, '#e5590a'),
            (0.67063, 0.78381, '#b83c02'),
            (0.78381, 1.00000, '#7f2704'),
        ],
        9: [
            (0.00000, 0.18544, '#fff5eb'),
            (0.18544, 0.28837, '#fee7cf'),
            (0.28837, 0.36386, '#fdd2a5'),
            (0.36386, 0.43646, '#fdb271'),
            (0.43646, 0.51071, '#fd9243'),
            (0.51071, 0.59821, '#f3701b'),
            (0.59821, 0.69516, '#df5005'),
            (0.69516, 0.79615, '#b13a03'),
            (0.79615, 1.00000, '#7f2704'),
        ],
        10: [
            (0.00000, 0.17124, '#fff5eb'),
            (0.17124, 0.27100, '#fee8d2'),
            (0.27100, 0.34233, '#fdd6af'),
            (0.34233, 0.40784, '#fdbd83'),
            (0.40784, 0.47367, '#fda057'),
            (0.47367, 0.54453, '#fa8331'),
            (0.54453, 0.62715, '#ee6511'),
            (0.62715, 0.71535, '#d94901'),
            (0.71535, 0.80670, '#ab3803'),
            (0.80670, 1.00000, '#7f2704'),
        ],
    },
    'Jenks': {
        2: [
            (0.00000, 0.50050, '#fff5eb'),
            (0.50050, 1.00000, '#7f2704'),
        ],
        3: [
            (0.00000, 0.34514, '#fff5eb'),
            (0.34514, 0.61940, '#fd9243'),
            (0.61940, 1.00000, '#7f2704'),
        ],
        4: [
            (0.00000, 0.25974, '#fff5eb'),
            (0.25974, 0.46456, '#fdbd83'),
            (0.46456, 0.67965, '#ee6511'),
            (0.67965, 1.00000, '#7f2704'),
        ],
        5: [
            (0.00000, 0.22223, '#fff5eb'),
            (0.22223, 0.39512, '#fdd2a5'),
            (0.39512, 0.56290, '#fd9243'),
            (0.56290, 0.73831, '#df5005'),
            (0.73831, 1.00000, '#7f2704'),
        ],
        6: [
            (0.00000, 0.19353, '#fff5eb'),
            (0.19353, 0.34108, '#fddab6'),
            (0.34108, 0.47612, '#fdab67'),
            (0.47612, 0.61803, '#f67723'),
            (0.61803, 0.76765, '#d14501'),
            (0.76765, 1.00000, '#7f2704'),
        ],
        7: [
            (0.00000, 0.17686, '#fff5eb'),
            (0.17686, 0.30692, '#fee0c2'),
            (0.30692, 0.42282, '#fdbd83'),
            (0.42282, 0.54283, '#fd9243'),
            (0.54283, 0.66972, '#ee6511'),
            (0.66972, 0.79832, '#c24002'),
            (0.79832, 1.00000, '#7f2704'),
        ],
        8: [
            (0.00000, 0.15768, '#fff5eb'),
            (0.15768, 0.27560, '#fee4ca'),
            (0.27560, 0.38085, '#fdc997'),
            (0.38085, 0.48328, '#fda45d'),
            (0.48328, 0.58959, '#f87f2c'),
            (0.58959, 0.70078, '#e5590a'),
            (0.70078, 0.81423, '#b83c02'),
            (0.81423, 1.00000, '#7f2704'),
        ],
        9: [
            (0.00000, 0.14598, '#fff5eb'),
            (0.14598, 0.25045, '#fee7cf'),
            (0.25045, 0.34048, '#fdd2a5'),
            (0.34048, 0.42846, '#fdb271'),
            (0.42846, 0.52172, '#fd9243'),
            (0.52172, 0.62131, '#f3701b'),
            (0.62131, 0.72439, '#df5005'),
            (0.72439, 0.82882, '#b13a03'),
            (0.82882, 1.00000, '#7f2704'),
        ],
        10: [
            (0.00000, 0.13562, '#fff5eb'),
            (0.13562, 0.23106, '#fee8d2'),
            (0.23106, 0.31336, '#fdd6af'),
            (0.31336, 0.39137, '#fdbd83'),
            (0.39137, 0.47096, '#fda057'),
            (0.47096, 0.55541, '#fa8331'),
            (0.55541, 0.64518, '#ee6511'),
            (0.64518, 0.73846, '#d94901'),
            (0.73846, 0.83580, '#ab3803'),
            (0.83580, 1.00000, '#7f2704'),
        ],
    },
    'Intervalos Iguales': {
        2: [
            (0.00000, 0.50326, '#fff5eb'),
            (0.50326, 1.00000, '#7f2704'),
        ],
        3: [
            (0.00000, 0.33834, '#fff5eb'),
            (0.33834, 0.66818, '#fd9243'),
            (0.66818, 1.00000, '#7f2704'),
        ],
        4: [
            (0.00000, 0.25588, '#fff5eb'),
            (0.25588, 0.50326, '#fdbd83'),
            (0.50326, 0.75064, '#ee6511'),
            (0.75064, 1.00000, '#7f2704'),
        ],
        5: [
            (0.00000, 0.20640, '#fff5eb'),
            (0.20640, 0.40431, '#fdd2a5'),
            (0.40431, 0.60221, '#fd9243'),
            (0.60221, 0.80012, '#df5005'),
            (0.80012, 1.00000, '#7f2704'),
        ],
        6: [
            (0.00000, 0.17342, '#fff5eb'),
            (0.17342, 0.33834, '#fddab6'),
            (0.33834, 0.50326, '#fdab67'),
            (0.50326, 0.66818, '#f67723'),
            (0.66818, 0.83310, '#d14501'),
            (0.83310, 1.00000, '#7f2704'),
        ],
        7: [
            (0.00000, 0.14986, '#fff5eb'),
            (0.14986, 0.29122, '#fee0c2'),
            (0.29122, 0.43258, '#fdbd83'),
            (0.43258, 0.57394, '#fd9243'),
            (0.57394, 0.71530, '#ee6511'),
            (0.71530, 0.85666, '#c24002'),
            (0.85666, 1.00000, '#7f2704'),
        ],
        8: [
            (0.00000, 0.13219, '#fff5eb'),
            (0.13219, 0.25588, '#fee4ca'),
            (0.25588, 0.37957, '#fdc997'),
            (0.37957, 0.50326, '#fda45d'),
            (0.50326, 0.62695, '#f87f2c'),
            (0.62695, 0.75064, '#e5590a'),
            (0.75064, 0.87433, '#b83c02'),
            (0.87433, 1.00000, '#7f2704'),
        ],
        9: [
            (0.00000, 0.11845, '#fff5eb'),
            (0.11845, 0.22839, '#fee7cf'),
            (0.22839, 0.33834, '#fdd2a5'),
            (0.33834, 0.44829, '#fdb271'),
            (0.44829, 0.55823, '#fd9243'),
            (0.55823, 0.66818, '#f3701b'),
            (0.66818, 0.77813, '#df5005'),
            (0.77813, 0.88807, '#b13a03'),
            (0.88807, 1.00000, '#7f2704'),
        ],
        10: [
            (0.00000, 0.10745, '#fff5eb'),
            (0.10745, 0.20640, '#fee8d2'),
            (0.20640, 0.30536, '#fdd6af'),
            (0.30536, 0.40431, '#fdbd83'),
            (0.40431, 0.50326, '#fda057'),
            (0.50326, 0.60221, '#fa8331'),
            (0.60221, 0.70116, '#ee6511'),
            (0.70116, 0.80012, '#d94901'),
            (0.80012, 0.89907, '#ab3803'),
            (0.89907, 1.00000, '#7f2704'),
        ],
    },
}